...
namespace ZapGen
{
    ...
    public class RpcRequest<TRequest> : IZapSerializable where TRequest : class
    {
        ...
        void IZapSerializable.Deserialize(DeserializerState arg_)
        {
            ...
            Request = ZapSerializable.Create<TRequest>(reader.Request);
            applyDefaults();
        }
    ...
    public class ArithmeticOperationRequest : IZapSerializable
    {
    ...
    public class ArithmeticOperationReply : IZapSerializable
    {
