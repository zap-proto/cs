using Zap.Net.Runtime.Tests.GenImpls;
using Zap.Rpc;
...
using static Zap_test.Zap.Test.TestStructUnion;
...
namespace Zap.Net.Runtime.Tests
{
    ...
    public class SerializationTests
    {
        ...
        [TestMethod]
        public void ZapSerializableListBool()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<bool>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListByte()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<byte>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListSByte()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<sbyte>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListUShort()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<ushort>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListShort()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<short>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListInt()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<int>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListUInt()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<uint>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListLong()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<long>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListULong()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<ulong>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListFloat()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<float>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableListDouble()
        {
            ...
            list.Init(expected);
            DeserializerState d = list;
            var list2 = ZapSerializable.Create<IReadOnlyList<double>>(d);
            CollectionAssert.AreEqual(expected, list2.ToArray());
        }

        [TestMethod]
        public void ZapSerializableStruct()
        {
            var b = MessageBuilder.Create();
            ...
            var obj2 = ZapSerializable.Create<SomeStruct>(d);
            Assert.AreEqual("hello", obj2.SomeText);
            Assert.AreEqual("world", obj2.MoreText);
        }

        [TestMethod]
        public void ZapSerializableCapList()
        {
            var b = MessageBuilder.Create();
            b.InitCapTable();
            ...
            var list = ZapSerializable.Create<IReadOnlyList<ITestInterface>>(d);
        ...
        [TestMethod]
        public void ZapSerializableString()
        {
            ...
            DeserializerState d = list;
            var str = ZapSerializable.Create<string>(d);
            Assert.AreEqual(expected, str);
        }

        [TestMethod]
        public void ZapSerializableAnyPointer()
        {
            var b = MessageBuilder.Create();
            var obj = b.CreateObject<SomeStruct.WRITER>();
            obj.SomeText = "hello";
            obj.MoreText = "world";
            DeserializerState d = obj;
            var any = ZapSerializable.Create<AnyPointer>(d);
        ...
        class Unconstructible1 : IZapSerializable
        {
        ...
        class Unconstructible2 : IZapSerializable
        {
        ...
        [TestMethod]
        public void ZapSerializableWrongUse()
        {
            var d = default(DeserializerState);
            Assert.ThrowsException<ArgumentException>(() => ZapSerializable.Create<SerializationTests>(d));
            Assert.ThrowsException<ArgumentException>(() => ZapSerializable.Create<IReadOnlyList<SerializationTests>>(d));
            Assert.ThrowsException<ArgumentException>(() => ZapSerializable.Create<IReadOnlyList<DeserializerState>>(d));
            Assert.ThrowsException<ArgumentException>(() => ZapSerializable.Create<Unconstructible1>(d));
            Assert.ThrowsException<ArgumentException>(() => ZapSerializable.Create<Unconstructible2>(d));
        }
