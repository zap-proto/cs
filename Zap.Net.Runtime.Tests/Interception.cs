        ...
        public void InterceptServerSideObserveCall()
        {
            ...
            using (client)
            {
                ...
                using (var main = client.GetMain<ITestInterface>())
                {
                    ...
                    var pr = new Zap_test.Zap.Test.TestInterface.Params_Foo.READER(cc.InArgs);
                    Assert.AreEqual(123u, pr.I);

                    cc.ForwardToBob();

                    Assert.IsTrue(policy.Returns.ReceiveAsync().Wait(MediumNonDbgTimeout));
                    var rr = new Zap_test.Zap.Test.TestInterface.Result_Foo.READER(cc.OutArgs);
        ...
        public void InterceptClientSideModifyCall()
        {
            ...
            using (client)
            {
                ...
                using (var main = policy.Attach(client.GetMain<ITestInterface>()))
                {
                    ...
                    var pw = cc.InArgs.Rewrap<Zap_test.Zap.Test.TestInterface.Params_Foo.WRITER>();
                    pw.I = 123u;
                    pw.J = true;
                    ...
                    var rw = ((DynamicSerializerState)cc.OutArgs).Rewrap<Zap_test.Zap.Test.TestInterface.Result_Foo.WRITER>();
                    rw.X = "bar";
                    cc.OutArgs = rw;
        ...
        public void InterceptClientSideShortCall()
        {
            ...
            using (client)
            {
                ...
                using (var main = policy.Attach(client.GetMain<ITestInterface>()))
                {
                    ...
                    var rw = SerializerState.CreateForRpc<Zap_test.Zap.Test.TestInterface.Result_Foo.WRITER>();
                    rw.X = "bar";
                    cc.OutArgs = rw;
