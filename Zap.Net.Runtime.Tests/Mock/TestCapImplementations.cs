...
namespace Zap.Net.Runtime.Tests.GenImpls
{
    class Common
    {
    ...
    class Issue25AImpl : ZapGen.IIssue25A
    {
        public void Dispose()
        {
        }
    ...
    class CapHolderImpl<T> : ZapGen.ICapHolder<T>
        where T: class
    {
        T _cap;
    ...
    class CapHolderAImpl : ZapGen.ICapHolderA
    {
        IIssue25A _a;
    ...
    class Issue25BImpl : ZapGen.IIssue25B
    {
        ...
        {
            return Task.FromResult<ICapHolder<IIssue25A>>(new CapHolderImpl<ZapGen.IIssue25A>(_a));
        }
