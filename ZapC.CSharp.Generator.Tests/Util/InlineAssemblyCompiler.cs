...
namespace ZapC.CSharp.Generator.Tests.Util
{
    class InlineAssemblyCompiler
    {
        ...
        public static CompileSummary TryCompileZap(NullableContextOptions nullableContextOptions, params string[] code)
        {
            ...
            string zapRuntimePath = Path.GetFullPath(Path.Combine(
            ...
            var compilation = CSharpCompilation.Create(
                ...
                references: new MetadataReference[] {
                    ...
                    MetadataReference.CreateFromFile(zapRuntimePath) },
