...
{
    /// <summary>
    /// Represents a .zap -> code generator result
    /// </summary>
    public class GenerationResult
    {
        ...
        /// <summary>
        /// Messages read from standard error. Valid for both failure and success (zap might spit out some warnings).
        /// </summary>
        public IReadOnlyList<ZapMessage> Messages { get; internal set; }

        /// <summary>
        /// Error classification (if any error)
        /// </summary>
        public ZapProcessFailure ErrorCategory { get; internal set; }
    }
}
