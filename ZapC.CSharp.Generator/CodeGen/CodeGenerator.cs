namespace ZapC.CSharp.Generator.CodeGen
{
    ...
    internal class CodeGenerator
    {
        ...
        IEnumerable<MemberDeclarationSyntax> TransformStruct(TypeDefinition def)
        {
            ...
            {
                topDecl = topDecl.AddBaseListTypes(SimpleBaseType(_names.Type<Zap.IZapSerializable>(Nullability.NonNullable)));
            }
            else
            {
        ...
        internal string Transform(GenFile file)
        {
            ...
            var cu = CompilationUnit().AddUsings(
                UsingDirective(ParseName("Zap")),
                UsingDirective(ParseName("Zap.Rpc")),
