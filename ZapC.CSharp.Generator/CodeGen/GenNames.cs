        ...
        public TypeSyntax MakeListSerializerSyntax(Model.Type elementType, TypeDefinition scope)
        {
            switch (elementType.Tag)
            {
                ...
                case TypeTag.ListPointer:
                    return Type<Zap.ListOfPointersSerializer<Zap.DynamicSerializerState>>(Nullability.NonNullable);

                case TypeTag.CapabilityPointer:
                    return Type<Zap.ListOfCapsSerializer<Zap.Rpc.BareProxy>>(Nullability.NonNullable);

                case TypeTag.Data:
                    return Type<Zap.ListOfPointersSerializer<
                        Zap.ListOfPrimitivesSerializer<byte>>>(Nullability.NonNullable);
                ...
                case TypeTag.Text:
                    return Type<Zap.ListOfTextSerializer>(Nullability.NonNullable);

                case TypeTag.Void:
                    return Type<Zap.ListOfEmptySerializer>(Nullability.NonNullable);

                case TypeTag.Bool:
                    return Type<Zap.ListOfBitsSerializer>(Nullability.NonNullable);

                case TypeTag.F32:
                    return Type<Zap.ListOfPrimitivesSerializer<float>>(Nullability.NonNullable);

                case TypeTag.F64:
                    return Type<Zap.ListOfPrimitivesSerializer<double>>(Nullability.NonNullable);

                case TypeTag.S8:
                    return Type<Zap.ListOfPrimitivesSerializer<sbyte>>(Nullability.NonNullable);

                case TypeTag.U8:
                    return Type<Zap.ListOfPrimitivesSerializer<byte>>(Nullability.NonNullable);

                case TypeTag.S16:
                    return Type<Zap.ListOfPrimitivesSerializer<short>>(Nullability.NonNullable);

                case TypeTag.U16:
                case TypeTag.AnyEnum:
                    return Type<Zap.ListOfPrimitivesSerializer<ushort>>(Nullability.NonNullable);

                case TypeTag.S32:
                    return Type<Zap.ListOfPrimitivesSerializer<int>>(Nullability.NonNullable);

                case TypeTag.U32:
                    return Type<Zap.ListOfPrimitivesSerializer<uint>>(Nullability.NonNullable);

                case TypeTag.S64:
                    return Type<Zap.ListOfPrimitivesSerializer<long>>(Nullability.NonNullable);

                case TypeTag.U64:
                    return Type<Zap.ListOfPrimitivesSerializer<ulong>>(Nullability.NonNullable);
            ...
            switch (type.Tag)
            {
                ...
                case TypeTag.CapabilityPointer:
                    if (type.Parameter != null)
                        ...
                        return Type<Zap.Rpc.BareProxy>(nullability);
                ...
                case TypeTag.StructPointer:
                    switch (usage)
                    {
                        case TypeUsage.Reader:
                            return Type<Zap.DeserializerState>(Nullability.NonNullable);

                        case TypeUsage.Writer:
                            return Type<Zap.DynamicSerializerState>(Nullability.NullableRef);
                ...
                case TypeTag.Data:
                    switch (usage)
                    {
                        ...
                        case TypeUsage.Writer:
                            return Type<Zap.ListOfPrimitivesSerializer<byte>>(nullability);
                ...
                case TypeTag.ListPointer:
                    ...
                    {
                        case TypeUsage.Writer:
                            return Type<Zap.SerializerState>(Nullability.NonNullable);

                        case TypeUsage.Reader:
                            return Type<IReadOnlyList<Zap.DeserializerState>>(Nullability.NonNullable);
