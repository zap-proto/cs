    ...
    class DomainClassSnippetGen
    {
                ...
                case TypeTag.Data:
                    ...
                    return InvocationExpression(
                        MemberAccessExpression(
                            SyntaxKind.SimpleMemberAccessExpression,
                            writer,
                            IdentifierName(nameof(Zap.ListOfPrimitivesSerializer<int>.Init))))
                    ...
                    return ExpressionStatement(
                        InvocationExpression(
                            MemberAccessExpression(
                                ...
                                IdentifierName(nameof(Zap.DynamicSerializerState.SetObject))))
                        .AddArgumentListArguments(
            ...
            return ConditionalAccessExpression(
                ...
                InvocationExpression(
                    MemberBindingExpression(
                        IdentifierName(nameof(Zap.ReadOnlyListExtensions.ToReadOnlyList))))
        ...
        MemberDeclarationSyntax MakeSerializeInterfaceMethod()
        {
            return MethodDeclaration(PredefinedType(Token(SyntaxKind.VoidKeyword)),
                Identifier(nameof(Zap.IZapSerializable.Serialize)))
                .WithExplicitInterfaceSpecifier(
                    ExplicitInterfaceSpecifier(IdentifierName(nameof(Zap.IZapSerializable))))
                .AddParameterListParameters(
                    Parameter(_names.AnonymousParameter.Identifier)
                        .WithType(_names.Type<Zap.SerializerState>(Nullability.NonNullable)))
                .AddBodyStatements(
                    ExpressionStatement(
                            ...
                            Argument(
                                InvocationExpression(
                                    MemberAccessExpression(
                                        ...
                                        GenericName(Identifier(nameof(Zap.SerializerState.Rewrap)))
        ...
        MemberDeclarationSyntax MakeDeserializeMethod(TypeDefinition def)
        {
            ...
            return MethodDeclaration(PredefinedType(Token(SyntaxKind.VoidKeyword)),
                Identifier(nameof(Zap.IZapSerializable.Deserialize)))
                    .WithExplicitInterfaceSpecifier(
                        ExplicitInterfaceSpecifier(IdentifierName(nameof(Zap.IZapSerializable))))
                    .AddParameterListParameters(
                        Parameter(_names.AnonymousParameter.Identifier)
