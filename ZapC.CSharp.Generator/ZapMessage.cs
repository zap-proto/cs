...
{
    /// <summary>
    /// Represents a zap.exe output message
    /// </summary>
    public class ZapMessage
    {
        // zap outputs look like this:
        //   empty.zap:1:1: error: File does not declare an ID.  I've generated one for you.  Add this line to your file: @0xc82955a0c779197d;
        //   f:\code\invalid.zap:9:7-8: error: Ordinal @0 originally used here.
        ...
        //   f:\code\somefile:stream.zap:9:7-8: error: Ordinal @0 originally used here.
        ...
        public ZapMessage(string fullMessage)
        {
