...
namespace ZapC.CSharp.MsBuild.Generation
{
    ...
    {
        public CsFileGeneratorResult(FileGenerationResult generatorResult, string fileName, IReadOnlyList<ZapMessage> messages)
        {
        ...
        public CsFileGeneratorResult(string error, IReadOnlyList<ZapMessage> messages)
        {
            Error = error;
            Messages = messages;
        }
        ...
        public IReadOnlyList<ZapMessage> Messages { get; }
