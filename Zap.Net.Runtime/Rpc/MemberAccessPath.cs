...
{
    /// <summary>
    /// A path from an outer ZAP struct to an inner (probably deeply nested) struct member.
    /// </summary>
    public class MemberAccessPath
    {
        ...
        /// <summary>
        /// Deserializes a MemberAccessPath from ZAP representation.
        /// </summary>
        /// <param name="promisedAnswer">ZAP representation</param>
        ...
        /// <summary>
        /// Constructs a path from ZAP struct member offsets.
        /// </summary>
        ...
        {
            /// <summary>
            /// Deserializes a MemberAccess instance from ZAP representation.
            /// </summary>
            /// <param name="op">ZAP representation</param>
        ...
        public class StructMemberAccess: MemberAccess
        {
            ...
            /// </summary>
            /// <param name="offset">The ZAP struct member offset</param>
