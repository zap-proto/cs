...
namespace Zap.Rpc
{
    ...
    public class TcpRpcServer: ISupportsMidlayers, IDisposable
    {
        ...
        class Connection: IConnection
        {
            ...
            /// <summary>
            /// Installs a midlayer. A midlayer is a protocal layer that resides somewhere between zap serialization and the raw TCP stream.
        ...
        /// <summary>
        /// Installs a midlayer.
        /// A midlayer is a protocal layer that resides somewhere between zap serialization and the raw TCP stream.
        /// Thus, we have a hook mechanism for transforming data before it is sent to the TCP connection or after it was received
