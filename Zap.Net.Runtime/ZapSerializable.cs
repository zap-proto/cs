...
namespace Zap
{
    ...
    /// </summary>
    public static class ZapSerializable
    {
        ...
        {
            if (typeof(IZapSerializable).IsAssignableFrom(type))
            {
                try
                {
        ...
        /// <list type="bullet">
        /// <item><description>Type implementing <see cref="IZapSerializable"/>. The type must must have a public parameterless constructor.</description></item>
