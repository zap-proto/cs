...
{
    /// <summary>
    /// This SerializerState specialization provides functionality to build arbitrary ZAP objects without requiring the schema code generator.
    /// </summary>
    public class DynamicSerializerState : SerializerState
    {
        ...
        /// The ZAP serialization intrinsically supports this, since messages are object graphs, not trees.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description>An instance implementing <see cref="IZapSerializable"/></description></item>
        ...
        public void SetObject(object? obj)
        {
            ...
            switch (obj)
            {
                case IZapSerializable serializable:
